...
(async() => {
    ...
    let writerStream = fs.createWriteStream('tmp/car_brands.json');
    writerStream.write(JSON.stringify(brands, undefined, 2),
        'UTF8');
    writerStream.end();
    ...
    // 将车辆信息写入文件
    writerStream = fs.createWriteStream('tmp/car_info_list.json');
    writerStream.write(JSON.stringify(carList, undefined, 2),
        'UTF8');
    writerStream.end();
